...
export const Toolbar = Object.assign(
  ...
  React.forwardRef((props: Props, ref: Ref<HTMLDivElement>) => {
    const {onFocus, onKeyDown, onMouseDown, children, ...otherProps} = props;
    ...
    const handleMouseDown = useCallback((e: MouseEvent<HTMLDivElement>) => {
      // Prevent mouse focus within the toolbar unless it already contains focus
      // or the target is a <select>
      if (
        !ownRef.current?.contains(document.activeElement) &&
