...
export const InsertRowAboveIcon = ({size = 24}) =>
...
InsertRowAboveIcon.propTypes = {
  size: PropTypes.number,
};

export const InsertRowBelowIcon = ({size = 24}) =>
  <svg width={size} height={size} viewBox='0 0 24 24'>
...
InsertRowBelowIcon.propTypes = {
  size: PropTypes.number,
};

export const DeleteRowIcon = ({size = 24}) =>
  <svg width={size} height={size} viewBox='0 0 24 24'>
...
export const InsertColumnBeforeIcon = ({size = 24}) =>
  <svg width={size} height={size} viewBox='0 0 24 24'>
...
InsertColumnBeforeIcon.propTypes = {
  size: PropTypes.number,
};

export const InsertColumnAfterIcon = ({size = 24}) =>
  <svg width={size} height={size} viewBox='0 0 24 24'>
...
InsertColumnAfterIcon.propTypes = {
  size: PropTypes.number,
};

export const DeleteColumnIcon = ({size = 24}) =>
  <svg width={size} height={size} viewBox='0 0 24 24'>
