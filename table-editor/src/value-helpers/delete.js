...
const getOverlapSize = (selMin, selMax, cellPos, cellSpan) => {
...
export const deleteSelectedRows = value => {
    ...
    // Second pass: find multi-row cells that start *inside* the rows.
    {
      ...
      if (
        ...
        const insertIndex =
          ...
          nextRowNewCells;
        newRows = newRows.updateIn([nextRow, 'cells'], cells =>
...
export const deleteSelectedColumns = value => {
  const {selection, layout} = value;
