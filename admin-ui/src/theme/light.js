...
const LightTheme = createTheme({
  ...
  primary: {
    ...
    hoverAltBg: primaryColor(Saturation.high, 45),
  ...
  secondary: {
    ...
    hoverAltBg: secondaryColor(Saturation.high, 25),
  ...
  danger: {
    ...
    hoverAltBg: dangerColor(Saturation.high, 47),
  ...
  general: {
    ...
    hoverAltBg: generalColor(Saturation.high, 90),
