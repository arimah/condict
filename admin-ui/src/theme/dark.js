...
const DarkTheme = createTheme({
  ...
  primary: {
    ...
    hoverAltBg: primaryColor(Saturation.high, 70),
  ...
  secondary: {
    ...
    hoverAltBg: secondaryColor(Saturation.high, 90),
  ...
  danger: {
    ...
    altFg: '#000000',
    altBg: dangerColor(Saturation.high, 70),
    hoverAltBg: dangerColor(Saturation.high, 75),
    activeAltBg: dangerColor(Saturation.high, 65),
    disabledAltFg: '#000000',
  ...
  general: {
    ...
    hoverAltBg: generalColor(Saturation.high, 30),
    activeAltBg: generalColor(Saturation.high, 20),
